...
use patp\Controllers\HomeController;
...
class TutsupMVC
{
    ...
    public function __construct()
    {
        ...
        if (!$this->controlador) {
            ...
            $this->controlador = new HomeController(array(), 'home', '');
        ...
        $formatController = explode('-', $this->controlador);
        $formatController = array_map(function ($word) {
            return ucfirst($word);
        }, $formatController);
        $formatController = implode($formatController);
        $this->controlador = 'patp\\Controllers\\' . $formatController;
        ...
        $this->controlador = new $this->controlador($this->parametros, $this->controller, $this->acao);
    ...
    public function getUrlData()
    {
        ...
        if (isset($_GET['path'])) {
            ...
            $this->controlador = $this->controller . '-controller';
